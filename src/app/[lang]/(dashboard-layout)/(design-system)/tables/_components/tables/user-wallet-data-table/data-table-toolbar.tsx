    ...
    <>
                  ...
                  <FormControl>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="GREATER_THAN_ZERO">Greater Than Zero</SelectItem>
                      </SelectContent>
                    </Select>
                  </FormControl>
                  <FormMessage>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-lg max-h-[90vh] overflow-visible">
          <DialogHeader>
            <DialogTitle>{dictionary.dialogFormLabels.sendAnnouncement}</DialogTitle>
          </DialogHeader>

          <NotificationObjectForm onClose={() => setOpen(false)} callback={callback} dictionary={dictionary} />
        </DialogContent>
      </Dialog>
    </>
  )
