...
import { UserWalletForm } from "@/app/[lang]/(dashboard-layout)/pages/user-wallet/_components/userWalletForm"
  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-lg sm:max-w-[75vw] h-[90vh] flex flex-col">
          <UserWalletForm
            onClose={() => setOpen(false)}
            userWalletDetails={rowData}
