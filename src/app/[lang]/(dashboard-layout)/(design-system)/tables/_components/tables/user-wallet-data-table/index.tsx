...
import { getAllUserWallet } from "@/components/dashboards/services/apiService"
import { getColumns } from "./columns"
import { InvoiceTableToolbar } from "./data-table-toolbar"

export function UserWalletDataTable() {
  ...
  return (
    <Card>
      <CardHeader className="flex-row justify-between items-center gap-x-1.5 space-y-0">
        <CardTitle>{dictionary.tableLabels.userWalletDataTable}</CardTitle>
        <InvoiceTableToolbar
          table={table}
