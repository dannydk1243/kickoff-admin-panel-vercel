...
export const coreBenefitsData: CoreBenefitType[] = [
  {
    ...
    description:
      "KickOFF equips developers with the latest tools to rapidly build scalable, modern dashboards with less friction.",
    points: [
  ...
  },
  {
    ...
    description:
      "With customizable themes and built-in accessibility, KickOFF adapts seamlessly to your team’s needs and user diversity.",
    points: [
  ...
  },
  {
    ...
    description:
      "KickOFF includes essential, production-ready features like authentication, form validation, and rich data components.",
    points: [
